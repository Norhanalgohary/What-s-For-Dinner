...
function displayMealWithDetails() {
    ...
    menu.innerHTML = `
      <div class="col-lg-5 col-sm-12 bg-white  position-relative rounded-start-5 ro">
            ...
            <img src="${randomMeal.imgCover}" alt="${randomMeal.image}" class="w-100 h-100  rounded-start-5 object-fit-lg-cover object-fit-sm-contain">
         ...
         <div class="col-lg-7 col-sm-12 bg-white border-danger-subtle rounded-end-5 px-5 py-4 overflow-y-scroll ">
...
<div class="tab-content overflow-y-scroll" id="myTabContent">
   <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0"> <div style="background-color:#FFFAEC ;" class="my-3 p-3 rounded-2" > 
  
  
    ${randomMeal.ingredients.map((ingredient, index) => `

      <div 
        class=" d-flex align-items-center p-2 rounded-2"
        style="background-color:#FFFAEC; width:90% ;">

        <div 
          class="me-3 rounded-circle text-center align-content-center"
          style="
            width: 30px;
            height: 30px;
  ...
  <div class="tab-pane fade " id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
    <div style="background-color:white ; " class="my-3">
     ${randomMeal.instructions.map((instructions, index) => `
      <div class="d-flex justify-content-between align-items-center px-1 py-2  rounded-2" style="width: 100%; background-color: ">
        <div class="d-flex align-items-center ">
          <div class="position-relative me-2  rounded-3 text-center align-content-center text-white" style="width: 45px ; height: 45px; background-color: #FF6900; font-weight: 700; font-size: 20px;"> ${index + 1}</div>


          <h6 style="font-weight: 400; font-size: 16px; color: oklch(0.373 0.034 259.733);"> ${instructions}</h6>
        </div>
...
<div class="d-flex justify-content-between align-items-center bg-body-tertiary p-3  mb-2 rounded-2" style="width: 49%; background-color: #F9FAFB;">
    ...
    <div style="background-color:white ;" class="my-3">
    ${randomMeal.instructions.map((instructions, index) => `
      <div class="col-12 rounded-3 d-flex align-items-center px-2 py-4 mb-2" style="background-color: #FFFBEB; border-left: #E17100 5px solid;">
           <i class="fa-solid fa-circle-check me-2" style="color: rgb(255, 111, 0);"></i>
          <h6 style="font-weight: 400; font-style: 16px; color: oklch(0.373 0.034 259.733);">${instructions}</h6>
